        ...
        <main className="flex flex-col items-center justify-center py-16">
              ...
              >
                <div className="flex flex-col items-start gap-1.5 relative self-stretch w-full">
                  ...
                  <Input
                    ...
                    className={`shadow-none px-0 text-${
                      index === 0
                        ? "uusj-themesysdarksurface-container-highest"
                        : "palette-text-primary"
                    } border-0 border-b border-gray-300 rounded-none relative flex-1 mt-[-1.00px] font-input-value font-[number:var(--input-value-font-weight)] text-[length:var(--input-value-font-size)] tracking-[var(--input-value-letter-spacing)] leading-[var(--input-value-line-height)] [font-style:var(--input-value-font-style)]`}
                  />
          ...
          <div className="flex gap-8 mt-16">
            <Button
              ...
              className="w-[300px] h-[66px] bg-[#222222] hover:bg-[#666666] cursor-pointer rounded-[10px] text-white text-2xl font-semibold [font-family:'Roboto-SemiBold',Helvetica] tracking-[0.15px]"
            >
              UPDATE
            </Button>
          </div>
